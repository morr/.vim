...
command! -range JSLintLight <line1>,<line2>call g:JSLint("echo")
" Highlight errors and open quick fix window
command! -range JSLint <line1>,<line2>call g:JSLint("qf")
" Un Highlight errors
command! JSLintClear call s:JSLintClear()

" set up auto commands
"autocmd! BufReadPost,BufWritePost,FileWritePost *.js,*.phtml JSLint
