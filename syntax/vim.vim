...
syn match vimVar contained	"\<\K\k*\>" contains=vimAccessor
...
syn region vimOperParen 	oneline matchgroup=vimOper start="(" end=")" contains=@vimOperGroup,vimAccessor
...
syn region vimString	oneline keepend	start=+[^:a-zA-Z>!\\@]"+lc=1 skip=+\\\\\|\\"+ end=+"+	contains=@vimStringGroup,vimAccessor
syn region vimString	oneline keepend	start=+[^:a-zA-Z>!\\@]'+lc=1 end=+'+
syn region vimString	oneline	start=+=!+lc=1	skip=+\\\\\|\\!+ end=+!+	contains=@vimStringGroup,vimAccessor
syn region vimString	oneline	start="=+"lc=1	skip="\\\\\|\\+" end="+"	contains=@vimStringGroup,vimAccessor
syn region vimString	oneline	start="\s/\s*\A"lc=1 skip="\\\\\|\\+" end="/"	contains=@vimStringGroup,vimAccessor
...
" Accessors {{{2
"============
syn match vimAccessor "\<g:\|\<v:\|\<s:\|\<b:\|\<w:\|\<t:\|\<l:\|\<a:"
...
hi! def link vimAccessor	Special
...
hi def link vimOperParen	Identifier
